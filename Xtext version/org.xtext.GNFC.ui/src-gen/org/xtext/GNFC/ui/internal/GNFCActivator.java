 ...
 */
package org.xtext.GNFC.ui.internal;
 ...
 * introduced subclass. 
 */
public class GNFCActivator extends AbstractUIPlugin {

	public static final String PLUGIN_ID = "org.xtext.GNFC.ui";
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(GNFCActivator.class);
	
	private static GNFCActivator INSTANCE;
	...
	public static GNFCActivator getInstance() {
		return INSTANCE;
	}
